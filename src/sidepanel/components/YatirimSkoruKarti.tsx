 ...
 *
 * Skor + boyut kırılımı herkese açık; ROI / IRR / Al-Sat Pro.
 */
...
export function YatirimSkoruKarti({ parsel, fiyat: fiyatProp, cevre, ePlan }: Props) {
  ...
  const kira = useMemo(() => (acik ? kiraTahminiHesapla(parsel) : null), [parsel, acik]);
  ...
  }, [acik, fiyatTutari, kira, trendYillikDegisim]);
      ...
      <div className="space-y-2 p-2">
        ...
        {acik ? (
          ...
          <PaywallKilit
            ...
            ozellik="📈 ROI / IRR / Cap Rate + Al-Sat kararı"
            kompakt
          />
        )}
      </div>
